...
\restrict GZovRgSaEATW4lFniIpg1VIwGJgPFnhbkN3a9zhRfKmgubQcajDi31XfwPcfZax
...
ALTER SEQUENCE public.cms_id_seq OWNER TO postgres;
...
--
-- Name: door_logs; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.door_logs OWNER TO postgres;

--
-- Name: door_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.door_logs_id_seq OWNER TO postgres;

--
-- Name: door_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: door_logs id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Data for Name: door_logs; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: door_logs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: door_logs door_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: cms_section_key_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: settings_user_id_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: door_logs door_logs_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict GZovRgSaEATW4lFniIpg1VIwGJgPFnhbkN3a9zhRfKmgubQcajDi31XfwPcfZax
