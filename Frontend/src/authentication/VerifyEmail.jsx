// authentication/VerifyEmail.jsx
    ...
    <AuthLayout dotActive={1}>
      ...
      {status === "success" && (
        <div style={{
          ...
          <p style={{ color: "#15803d", fontSize: "14px", fontWeight: 600, marginBottom: "4px" }}>
            ✅ {message}
          </p>
      ...
      {status === "error" && (
        <div style={{
          ...
          <p style={{ color: "#be123c", fontSize: "14px", fontWeight: 600, marginBottom: "4px" }}>
            ❌ Verification failed
          </p>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginTop: "8px" }}>
        {(status === "success") && (
          <Link to="/login" className="auth-btn" style={{ textAlign: "center", textDecoration: "none" }}>
            Go to Login
          </Link>
        )}
        {status === "error" && (
          <Link to="/login" style={{ color: "#1d4ed8", fontSize: "13px", textAlign: "center" }}>
            Back to Login →
          </Link>
        )}
      </div>
